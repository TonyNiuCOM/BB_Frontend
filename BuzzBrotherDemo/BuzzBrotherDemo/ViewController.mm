...
@synthesize tapGestureRecognizer, vapp, tarView;
...
- (void)loadView
{
    ...
    tarView = [[ImageTargetView alloc] initWithFrame:viewFrame appSession:vapp];
    [self setView:tarView];
...
- (void) resumeAR {
    ...
    [tarView updateRenderingPrimitives];
...
- (void)finishOpenGLESCommands
{
    ...
    [tarView finishOpenGLESCommands];
}

- (void)freeOpenGLESResources
{
    // Called in response to applicationDidEnterBackground.  Inform the EAGLView
    [tarView freeOpenGLESResources];
}
...
- (void) showLoadingAnimation {
    ...
    [tarView addSubview:loadingIndicator];
...
- (void) onInitARDone:(NSError *)initError {
    UIActivityIndicatorView *loadingIndicator = (UIActivityIndicatorView *)[tarView viewWithTag:1];
...
{
    [tarView configureVideoBackgroundWithViewWidth:(float)viewWidth andHeight:(float)viewHeight];
}
...
{
    ViewController *back = [self.storyboard instantiateViewControllerWithIdentifier:@"EntranceViewController"];
